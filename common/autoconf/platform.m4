...
[
  ...
  ADDED_CFLAGS=" -m${OPENJDK_TARGET_CPU_BITS} -Wno-stringop-overflow -Wno-literal-suffix"
  ADDED_CXXFLAGS=" -m${OPENJDK_TARGET_CPU_BITS} -Wno-stringop-overflow -Wno-literal-suffix"
